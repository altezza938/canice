...
import { Clock, MapPin, Plus, Edit2, Check, X } from 'lucide-react'
...
export default function EventCard({ event, t, onSave }) {
  const [editing, setEditing] = useState(false)
  const [form, setForm] = useState({
    customTitle:   event.isEdited ? event.customTitle : t[event.titleKey],
    start:         event.start,
    end:           event.end,
